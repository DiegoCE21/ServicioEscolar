...
<body>
    ...
    <div class="student-profile container">
        ...
        <div class="profile-info text-center">
            ...
            <p>Sube tus documentos para poder postularte a un programa del servicio social</p>
        </div>
    </div>
...
<head>
  ...
  .file-input-container {
    ...
    align-items: center;
    margin-bottom: 10px;
    width: 300px; /* Ancho fijo para todos los campos de archivo */
  }
...
<body>
  ...
  <input type="submit" value="Subir archivos" id="submitButton">
  <p id = "mensaje"></p>
</form>
  ...
  document.getElementById('uploadForm').addEventListener('submit', function(event) {
    ...
    if (constanciaEstudios || cartaCumplimiento || curp || actaNacimiento) {
      ...
      setTimeout(function() {
        ...
        document.getElementById('mensaje').textContent = 'Tus documentos se han enviado para revisión';
