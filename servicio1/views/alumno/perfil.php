...
<body>
    <div class="container">
        <div class="column">
            ...
            <div class="avatar2">
                <img src="https://media.istockphoto.com/id/1288634246/es/foto/joven-estudiante-latina-sonriendo-feliz-carpeta-en-la-ciudad.jpg?b=1&s=612x612&w=0&k=20&c=In-7V0lbhjNip4gV29vJY7HfL-BgADc8dEp8LEkBUEY=" style="display: inline-block; width: 100%; max-width: 150px;">
            </div>
        </div>
        <div class="column">
