...
<body>
    ...
    function toggleWindow() {
        ...
        if (popup.style.display === "none" || popup.style.display === "") {
            ...
            } else if(selectedButton === "dependenciasButton"){
                url = "<?= $urlConstant ?>dependencias";
            }
            else {
            ...
            fetch(url)
                ...
                .then(data => {
                    ...
                    if (selectedButton === "programasButton" || selectedButton === "alumnosButton" || selectedButton === "dependenciasButton") {
    ...
    var dependenciasButton = document.getElementById("dependenciasButton");
    ...
    dependenciasButton.addEventListener("click", toggleWindow);
