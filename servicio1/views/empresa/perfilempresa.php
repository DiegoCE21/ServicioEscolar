...
<body>
    <div class="container">
        <div class="column">
            <h2>Tu información es:</h2>
            <div class="avatar2">
                <img src="https://cdn-icons-png.flaticon.com/512/53/53083.png" style="display: inline-block; width: 100%; max-width: 150px;">
            </div>
        </div>
        <div class="column">
            <ul id="timeline" class="timeline">
                <li class="animated fadeIn fast">
                    <div class="bubble-columns">
                        <div>
                            <strong>
                                <p>Nombre:</strong> <?php echo $nombre; ?></p>
                            <strong>
                                <p>Teléfono:</strong> <?php echo $telefono; ?></p>
                            <strong>
                                <p>Correo electrónico:</strong> <?php echo $correo; ?></p>
                            <strong>
                                <p>Reportes entregados:</strong> 2 reportes</p>
                        </div>
                        <div>
                            <strong>
                                <p>Contraseña:</strong> <?php echo $contrasena; ?></p>
                            <strong>
                                <p>Alumnos haciendo servicio:</strong> 15 alumnos</p>
                        </div>
                    </div>
                    <div class="arrow"></div>
                </li>
