...
class AlumnosEmpresaModel extends Model {
    ...
    public function getDatos() {
        try {
            $query = $this->prepare('SELECT CONCAT(estudiante.nom_estudiante, " ", estudiante.ap_estudiante, " ", estudiante.am_estudiante) AS nombre_estudiante, telefono, correo, nombre_escuela, carrera, nombre_empresa
