<?php
class EstudiantePerfilModel extends Model {
    ...
    public function getAllData($id_estudiante) {
        try {
            $query = $this->prepare('SELECT CONCAT(estudiante.nom_estudiante, " ", estudiante.ap_estudiante, " ", estudiante.am_estudiante) AS nombre, telefono, correo, nombre_escuela, carrera
